...
exports.add_blogpost = function (doc, req) {
    ...
    return {title: config.site_name + ' - Add new blogpost', site_name: config.site_name, content: content};
};
...
exports.edit_blogpost = function (doc, req) {
    ...
    return {title: config.site_name + ' - Edit blogpost - '+doc.title, site_name: config.site_name, content: content};
};
